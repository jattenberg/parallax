 ...
 * for more info
 */
public class GradientUpdateableQuadraticSVM extends
		AbstractGradientUpdateableClassifier<GradientUpdateableQuadraticSVM> {
	 ...
	 */
	public GradientUpdateableQuadraticSVM(int dimension, boolean bias) {
	 ...
	 *            should the model have an additional (+1) intercept term?
	 */
	public GradientUpdateableQuadraticSVM(
	 ...
	 */
	public GradientUpdateableQuadraticSVM setGamma(double gamma) {
	 ...
	 */
	@Override
	public GradientUpdateableQuadraticSVM initialize() {
		super.initialize();
		return model;
	}
	 ...
	 */
	@Override
	protected GradientUpdateableQuadraticSVM getModel() {
		return this;
	}
