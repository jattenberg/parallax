...
/**
 * The Class TestLessThanOrEqualsToSplitCondition.
 */
public class TestLessThanOrEqualsToSplitCondition {
	...
	@Test
	public void test() {
		LessThanOrEqualsToSplitCondition cond = new LessThanOrEqualsToSplitCondition(
				1, 3);

		for (BinaryClassificationInstance inst : insts) {
			assertEquals(cond.satisfiesSplit(inst),
					inst.getFeatureValue(1) <= 3);
		}
	}
